...
public class SpriteStore {
	...
	private HashMap<String, Sprite> sprites = new HashMap<String, Sprite>(); // key, value pairs that stores the sprites
	 ...
	 */
	public Sprite getSprite(String ref, double scale) {
		...
		Sprite sprite = new Sprite(image.getScaledInstance((int) (sourceImage.getWidth() / scale),
				(int) (sourceImage.getHeight() / scale), Image.SCALE_DEFAULT));
